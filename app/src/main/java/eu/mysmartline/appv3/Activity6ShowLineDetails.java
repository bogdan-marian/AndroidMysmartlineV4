...
public class Activity6ShowLineDetails extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		lineDetails = (LineDetailsModel) getIntent().getSerializableExtra(
				"LineDetailsModel");
		textView1.setText(lineDetails.getName()
				+ "\n\n" + getResources().getString(R.string.activiti6_to_get_in_line_please_scan));
